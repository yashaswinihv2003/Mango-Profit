...
T = {
    "English": {
        ...
        "name": "Full Name", "place": "Village / District",
        "reg_btn": "Create Account",
        "select_lang": "Language",
        "village_sel": "Select Your Village",
        "variety": "Mango Variety",
        "quantity": "Quantity (Tonnes)",
        "analyze_btn": "Find Best Markets & Profit",
        "top3": "Top 3 Most Profitable Destinations",
        "bar_title": "Net Profit by Destination",
        "pie_title": "Market Category Share",
        "map_title": "Route Map to Best Destination",
        "table_title": "All Destinations Compared",
        "rank": "Rank", "dest": "Destination", "cat": "Category",
        "dist_km": "Distance (km)", "rev": "Revenue (₹)",
        "trans": "Transport (₹)", "risk": "Risk (%)",
        "net": "Net Profit (₹)",
        "logout": "Sign Out",
        ...
        "variety_selected": "Variety", "qty_lbl": "Quantity",
        ...
        "tip_text": "Abroad Export gives highest premium (+7%) but needs quality certification. Local Export is easiest entry point.",
        "hero_sub": "Select your village and mango variety in the left panel, then click Analyse to find your most profitable market.",
        "varieties_lbl": "Varieties", "markets_lbl": "Market Types",
        "engine_lbl": "AI Engine", "districts_lbl": "Districts",
        "no_results": "No markets found within radius for this variety. Try increasing radius or changing variety.",
        "welcome": "Welcome back",
    },
    "Telugu": {
        "title": "మామిడి లాభం నావిగేటర్",
        "tagline": "వ్యవసాయ సమాచార వేదిక",
        ...
        "name": "పూర్తి పేరు", "place": "గ్రామం / జిల్లా",
        "reg_btn": "ఖాతా తెరవండి",
        "select_lang": "భాష",
        "village_sel": "మీ గ్రామాన్ని ఎంచుకోండి",
        "variety": "మామిడి రకం",
        "quantity": "పరిమాణం (టన్నులు)",
        "analyze_btn": "ఉత్తమ మార్కెట్లు కనుగొనండి",
        "top3": "అగ్ర 3 లాభదాయక గమ్యాలు",
        "bar_title": "గమ్యం వారీగా నికర లాభం",
        "pie_title": "మార్కెట్ వర్గం వాటా",
        "map_title": "ఉత్తమ గమ్యానికి మార్గ మ్యాప్",
        "table_title": "అన్ని గమ్యాల పోలిక",
        "rank": "స్థానం", "dest": "గమ్యం", "cat": "వర్గం",
        "dist_km": "దూరం (కి.మీ)", "rev": "ఆదాయం (₹)",
        "trans": "రవాణా (₹)", "risk": "రిస్క్ (%)",
        "net": "నికర లాభం (₹)",
        "logout": "నిష్క్రమించు",
        "reset_pw": "పాస్‌వర్డ్ రీసెట్", "new_pw": "కొత్త పాస్‌వర్డ్",
        "conf_pw": "నిర్ధారించండి", "upd_pw": "అప్‌డేట్ చేయండి",
        "back": "లాగిన్‌కు తిరిగి వెళ్ళండి", "use_pw": "పాస్‌వర్డ్ ఉపయోగించండి",
        "live_market": "ప్రస్తుత మార్కెట్ ధరలు",
        "highest_profit": "అత్యధిక లాభం",
        ...
        "variety_selected": "రకం", "qty_lbl": "పరిమాణం",
        ...
        "hero_sub": "ఎడమ పానెల్‌లో మీ గ్రామం మరియు మామిడి రకం ఎంచుకోండి.",
        "varieties_lbl": "రకాలు", "markets_lbl": "మార్కెట్ రకాలు",
        "engine_lbl": "AI ఇంజన్", "districts_lbl": "జిల్లాలు",
        "no_results": "ఈ రకానికి సమీపంలో మార్కెట్లు కనుగొనబడలేదు.",
        "welcome": "స్వాగతం",
    },
    "Hindi": {
        "title": "आम लाभ नेविगेटर",
        "tagline": "कृषि बुद्धिमत्ता मंच",
        ...
        "name": "पूरा नाम", "place": "गाँव / जिला",
        "reg_btn": "खाता बनाएं",
        "select_lang": "भाषा",
        "village_sel": "अपना गाँव चुनें",
        "variety": "आम की किस्म",
        "quantity": "मात्रा (टन)",
        "analyze_btn": "सर्वोत्तम बाज़ार खोजें",
        "top3": "शीर्ष 3 लाभदायक गंतव्य",
        "bar_title": "गंतव्य अनुसार शुद्ध लाभ",
        "pie_title": "बाज़ार श्रेणी हिस्सेदारी",
        "map_title": "सर्वोत्तम गंतव्य का मार्ग",
        "table_title": "सभी गंतव्यों की तुलना",
        "rank": "रैंक", "dest": "गंतव्य", "cat": "श्रेणी",
        "dist_km": "दूरी (कि.मी.)", "rev": "राजस्व (₹)",
        "trans": "परिवहन (₹)", "risk": "जोखिम (%)",
        "net": "शुद्ध लाभ (₹)",
        "logout": "साइन आउट",
        ...
        "variety_selected": "किस्म", "qty_lbl": "मात्रा",
        "best_market": "सर्वोत्तम बाज़ार", "est_profit": "अनुमानित लाभ",
        "how_works": "लाभ की गणना कैसे होती है",
        "step1": "निकटतम मंडी से आधार मूल्य",
        "step2": "बाज़ार प्रकार के अनुसार प्रीमियम",
        "step3": "परिवहन + जोखिम लागत घटाई गई",
        "step4": "शुद्ध लाभ रैंक किया गया",
        "farmer_tip": "किसान सुझाव",
        "tip_text": "विदेश निर्यात सबसे अधिक प्रीमियम (+7%) देता है लेकिन गुणवत्ता प्रमाणीकरण आवश्यक है।",
        "hero_sub": "बाईं पैनल में अपना गाँव और आम की किस्म चुनें।",
        "varieties_lbl": "किस्में", "markets_lbl": "बाज़ार प्रकार",
        "engine_lbl": "AI इंजन", "districts_lbl": "जिले",
        "no_results": "इस किस्म के लिए पास में कोई बाज़ार नहीं मिला।",
        "welcome": "स्वागत है",
    },
    "Kannada": {
        "title": "ಮಾವಿನ ಲಾಭ ನ್ಯಾವಿಗೇಟರ್",
        "tagline": "ಕೃಷಿ ಬುದ್ಧಿಮತ್ತೆ ವೇದಿಕೆ",
        ...
        "name": "ಪೂರ್ಣ ಹೆಸರು", "place": "ಗ್ರಾಮ / ಜಿಲ್ಲೆ",
        "reg_btn": "ಖಾತೆ ತೆರೆಯಿರಿ",
        "select_lang": "ಭಾಷೆ",
        "village_sel": "ನಿಮ್ಮ ಗ್ರಾಮ ಆಯ್ಕೆ ಮಾಡಿ",
        "variety": "ಮಾವಿನ ತಳಿ",
        "quantity": "ಪ್ರಮಾಣ (ಟನ್)",
        "analyze_btn": "ಉತ್ತಮ ಮಾರುಕಟ್ಟೆ ಹುಡುಕಿ",
        "top3": "ಅಗ್ರ 3 ಲಾಭದಾಯಕ ಗಮ್ಯಗಳು",
        "bar_title": "ಗಮ್ಯದ ಪ್ರಕಾರ ನಿವ್ವಳ ಲಾಭ",
        "pie_title": "ಮಾರುಕಟ್ಟೆ ವಿಭಾಗ ಪಾಲು",
        "map_title": "ಉತ್ತಮ ಗಮ್ಯಕ್ಕೆ ಮಾರ್ಗ ನಕ್ಷೆ",
        "table_title": "ಎಲ್ಲಾ ಗಮ್ಯಗಳ ಹೋಲಿಕೆ",
        "rank": "ಶ್ರೇಣಿ", "dest": "ಗಮ್ಯ", "cat": "ವರ್ಗ",
        "dist_km": "ದೂರ (ಕಿ.ಮೀ)", "rev": "ಆದಾಯ (₹)",
        "trans": "ಸಾರಿಗೆ (₹)", "risk": "ಅಪಾಯ (%)",
        "net": "ನಿವ್ವಳ ಲಾಭ (₹)",
        "logout": "ಸೈನ್ ಔಟ್",
        ...
        "variety_selected": "ತಳಿ", "qty_lbl": "ಪ್ರಮಾಣ",
        "best_market": "ಉತ್ತಮ ಮಾರುಕಟ್ಟೆ", "est_profit": "ಅಂದಾಜು ಲಾಭ",
        "how_works": "ಲಾಭ ಹೇಗೆ ಲೆಕ್ಕ ಹಾಕಲಾಗುತ್ತದೆ",
        "step1": "ಹತ್ತಿರದ ಮಂಡಿಯಿಂದ ಮೂಲ ಬೆಲೆ",
        "step2": "ಮಾರುಕಟ್ಟೆ ವಿಧದ ಆಧಾರದ ಮೇಲೆ ಪ್ರೀಮಿಯಂ",
        "step3": "ಸಾರಿಗೆ + ಅಪಾಯ ವೆಚ್ಚಗಳು ಕಳೆಯಲಾಗಿದೆ",
        "step4": "ನಿವ್ವಳ ಲಾಭ ರ್ಯಾಂಕ್ ಮಾಡಲಾಗಿದೆ",
        "farmer_tip": "ರೈತ ಸಲಹೆ",
        "tip_text": "ವಿದೇಶ ರಫ್ತು ಅತ್ಯಧಿಕ ಪ್ರೀಮಿಯಂ (+7%) ನೀಡುತ್ತದೆ ಆದರೆ ಗುಣಮಟ್ಟ ಪ್ರಮಾಣೀಕರಣ ಅಗತ್ಯ.",
        "hero_sub": "ಎಡ ಫಲಕದಲ್ಲಿ ನಿಮ್ಮ ಗ್ರಾಮ ಮತ್ತು ಮಾವಿನ ತಳಿ ಆಯ್ಕೆ ಮಾಡಿ.",
        "varieties_lbl": "ತಳಿಗಳು", "markets_lbl": "ಮಾರುಕಟ್ಟೆ ವಿಧಗಳು",
        "engine_lbl": "AI ಎಂಜಿನ್", "districts_lbl": "ಜಿಲ್ಲೆಗಳು",
        "no_results": "ಈ ತಳಿಗೆ ಸಮೀಪದಲ್ಲಿ ಮಾರುಕಟ್ಟೆ ಕಂಡುಬಂದಿಲ್ಲ.",
        "welcome": "ಸ್ವಾಗತ",
    },
}
...
.stTextInput>div>div>input:focus{
    ...
    background:rgba(255,255,255,0.11)!important;outline:none!important;
}
.stTextInput>div>div>input::placeholder{color:rgba(245,240,232,0.3)!important;font-size:13px!important;}
.stButton>button{
...
[data-testid="stSidebar"]{
    background:linear-gradient(180deg,#040e07 0%,#071209 60%,#040e07 100%)!important;
...
if not st.session_state.logged_in:
    ...
    with mid:
        ...
        st.markdown("""<div style="background:rgba(3,10,6,0.82);backdrop-filter:blur(36px);
            -webkit-backdrop-filter:blur(36px);border:1px solid rgba(212,175,55,0.14);
            border-radius:16px;padding:36px 36px 30px;
            box-shadow:0 48px 96px rgba(0,0,0,0.6),inset 0 1px 0 rgba(255,255,255,0.04);">
        """, unsafe_allow_html=True)
...
def load_all_data():
    ...
    villages    = safe_load("Village data.csv")
    prices      = safe_load("cleaned_price_data.csv")
    geo         = safe_load("cleaned_mandi_location.csv")
    processing  = safe_load("cleaned_processing_facilities.csv")
    pulp        = safe_load("Pulp_units_merged_lat_long.csv")
    pickle_u    = safe_load("cleaned_pickle_units.csv")
    local_exp   = safe_load("cleaned_local_export.csv")
    abroad_exp  = safe_load("cleaned_abroad_export.csv")
    cold        = safe_load("cleaned_cold_storage.csv")
    fpo         = safe_load("cleaned_fpo.csv")
    return villages, prices, geo, processing, pulp, pickle_u, local_exp, abroad_exp, cold, fpo
...
def get_village_list():
    name_col,_,_ = detect_cols(villages)
    if name_col and name_col in villages.columns:
        return sorted(villages[name_col].dropna().unique().tolist())
    return ["Default Village"]

def get_village_coords(village_name):
    name_col, lat_col, lon_col = detect_cols(villages)
    if name_col and lat_col and lon_col:
        row = villages[villages[name_col]==village_name]
        if not row.empty:
...
def get_base_price(v_lat, v_lon):
    try:
        if "market" in prices.columns and "market" in geo.columns:
            ...
            mandi = prices.copy()
        lat_col = next((c for c in mandi.columns if "lat" in c.lower()), None)
        lon_col = next((c for c in mandi.columns if "lon" in c.lower()), None)
        price_col = next((c for c in mandi.columns if "price" in c.lower()), None)
        if lat_col and lon_col and price_col:
            mandi = mandi.dropna(subset=[lat_col, lon_col, price_col])
            mandi["dist"] = mandi.apply(lambda r: haversine(v_lat,v_lon,r[lat_col],r[lon_col]),axis=1)
            nearest = mandi.loc[mandi["dist"].idxmin()]
            return float(nearest[price_col])
    except: pass
    return 25.0  # fallback price ₹/kg

def collect_alternatives(v_lat, v_lon, variety, radius=150):
    VARIETY_ACCEPTANCE = {
    ...
    CAT_CONFIG = {
        "Mandi":        {"margin":0.00,"color":"#3b82f6","icon":"🏪","df": prices if geo.empty else prices.merge(geo,on="market",how="left") if "market" in prices.columns and "market" in geo.columns else prices},
    ...
    for cat, cfg in CAT_CONFIG.items():
        if variety not in VARIETY_ACCEPTANCE.get(cat,[]): continue
        df_ = cfg["df"]
        if df_.empty: continue
        name_col, lat_col, lon_col = detect_cols(df_)
        if not lat_col or not lon_col: continue
        for _, row in df_.iterrows():
            try:
                rlat = float(row[lat_col]); rlon = float(row[lon_col])
                dist = haversine(v_lat, v_lon, rlat, rlon)
                if dist <= radius:
                    nm = str(row[name_col]) if name_col and name_col in row.index else cat
                    rows.append({"Type":cat,"Name":nm,"Lat":rlat,"Lon":rlon,
                                 "Dist":dist,"margin":cfg["margin"],
                                 "color":cfg["color"],"icon":cfg["icon"]})
            except: continue
    return pd.DataFrame(rows)

def calc_profit(df_alt, base_price, tonnes):
    COST_PER_KM   = 200
    FIXED_TRIP    = 5000
    LOADING_T     = 300
    SPOIL_PER_10K = 0.004
    HANDLING_RISK = 0.002
    HANDLING_COST = {"Mandi":0,"Processing":300,"Pulp":400,"Pickle":250,
                     "Local Export":500,"Abroad Export":700,"Cold Storage":200,"FPO":150}
    DELAY_DAYS    = {"Mandi":0,"Processing":7,"Pulp":10,"Pickle":5,
                     "Local Export":14,"Abroad Export":30,"Cold Storage":3,"FPO":2}
    INT_RATE = 0.12
    results = []
    for _, row in df_alt.iterrows():
        km     = row["Dist"]
        adj_p  = base_price * (1 + row["margin"])
        rev    = adj_p * 1000 * tonnes
        transport = FIXED_TRIP + km*COST_PER_KM*tonnes + LOADING_T*tonnes
        handling  = HANDLING_COST.get(row["Type"],0) * tonnes
        delay     = DELAY_DAYS.get(row["Type"],0)
        finance   = rev * (delay/365) * INT_RATE
        risk_rate = SPOIL_PER_10K*(km/10) + HANDLING_RISK
        risk_cost = rev * risk_rate
        net = rev - transport - handling - finance - risk_cost
        results.append({
            "Type":row["Type"],"Name":row["Name"],
            "Dist_km":round(km,2),"Revenue":round(rev,2),
            "Transport":round(transport,2),"Risk_pct":round(risk_rate*100,2),
            "Risk_Cost":round(risk_cost,2),"Net_Profit":round(net,2),
...
farmer_name  = st.session_state.user[0]
farmer_place = st.session_state.user[1]
...
<div style="background:linear-gradient(135deg,#040e07 0%,#0a1c10 60%,#040e07 100%);
    ...
    <div style="display:flex;align-items:center;gap:14px;">
        <div style="width:38px;height:38px;background:linear-gradient(135deg,#d4af37,#b8942a);
            ...
            font-size:20px;box-shadow:0 4px 14px rgba(212,175,55,0.35);">🥭</div>
        <div>
            <div style="font-family:'Playfair Display',serif;font-size:19px;
                color:#f5f0e8;font-weight:400;">{tx['title']}</div>
            <div style="font-size:9px;color:rgba(212,175,55,0.5);
                letter-spacing:3px;text-transform:uppercase;">{tx['tagline']}</div>
        </div>
    </div>
...
with st.sidebar:
    ...
    run_btn = st.button(tx["analyze_btn"], use_container_width=True)
    if run_btn: st.session_state.run = True
    ...
    mkt = {"Banganapalli":(28,"+2.1%","#22c55e"),
           "Totapuri":(18,"-0.8%","#ef4444"),
           "Neelam":(22,"+1.4%","#22c55e"),
           "Rasalu":(30,"+3.2%","#22c55e")}
...
if not st.session_state.get("run", False):
    ...
    <div style="background:
        linear-gradient(135deg,rgba(4,14,7,0.92) 0%,rgba(7,24,12,0.88) 100%),
        url('https://images.unsplash.com/photo-1592991538534-00e70e6a5b3f?w=1400&q=85&fit=crop');
        ...
        <div style="position:absolute;right:52px;top:50%;transform:translateY(-50%);
            font-size:130px;opacity:0.07;filter:blur(2px);pointer-events:none;">🥭</div>
        ...
        <div style="font-family:'Playfair Display',serif;font-size:36px;
            color:#f5f0e8;font-weight:400;margin-bottom:10px;">
            {tx['welcome']}, {farmer_name}</div>
        ...
        <div style="margin-top:24px;display:flex;gap:14px;flex-wrap:wrap;">
            <div style="background:rgba(212,175,55,0.12);border:1px solid rgba(212,175,55,0.25);
                border-radius:8px;padding:10px 18px;display:inline-flex;align-items:center;gap:8px;">
                <span style="font-size:16px;">🌾</span>
                <span style="font-size:12px;color:#d4af37;font-weight:500;">1. Select Village</span>
            </div>
            <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);
                border-radius:8px;padding:10px 18px;display:inline-flex;align-items:center;gap:8px;">
                <span style="font-size:16px;">🥭</span>
                <span style="font-size:12px;color:rgba(245,240,232,0.5);font-weight:500;">2. Choose Variety</span>
            </div>
            <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);
                border-radius:8px;padding:10px 18px;display:inline-flex;align-items:center;gap:8px;">
                <span style="font-size:16px;">📊</span>
                <span style="font-size:12px;color:rgba(245,240,232,0.5);font-weight:500;">3. Click Analyse</span>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
    ...
    for col,lbl_,val,sub,acc,icon in [
        (c1,tx["varieties_lbl"],"4","Banganapalli · Totapuri · Neelam · Rasalu","#d4af37","🥭"),
        (c2,tx["markets_lbl"],"8","Mandi · Processing · Pulp · Pickle · Local · Export · Cold · FPO","#22c55e","🏪"),
        ...
        with col:
            ...
            <div style="background:white;border-radius:14px;padding:22px 20px;
                ...
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;">
                    ...
                    <div style="font-size:9px;letter-spacing:2px;text-transform:uppercase;color:#8a9a8d;">{lbl_}</div>
                </div>
    ...
    # Market prices panel
    st.markdown(f"""
    <div style="background:white;border-radius:14px;padding:26px 28px;
        border:1px solid rgba(0,0,0,0.05);box-shadow:0 2px 16px rgba(0,0,0,0.04);margin-bottom:20px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
            <div style="font-size:9px;letter-spacing:2.5px;text-transform:uppercase;color:#8a9a8d;">
                {tx['live_market']}</div>
            <div style="font-size:11px;color:#22c55e;font-weight:500;">● Live</div>
        </div>
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;">
            <div style="text-align:center;padding:18px 12px;background:#f8f6f0;border-radius:12px;">
                <div style="font-size:12px;color:#6b7c6e;margin-bottom:6px;">Banganapalli</div>
                <div style="font-size:28px;font-weight:700;color:#1a2e1f;">₹28</div>
                <div style="font-size:12px;font-weight:600;color:#22c55e;">↑ +2.1%</div>
                <div style="font-size:10px;color:#a8b0aa;margin-top:6px;">Best for export</div>
            </div>
            <div style="text-align:center;padding:18px 12px;background:#f8f6f0;border-radius:12px;">
                <div style="font-size:12px;color:#6b7c6e;margin-bottom:6px;">Totapuri</div>
                <div style="font-size:28px;font-weight:700;color:#1a2e1f;">₹18</div>
                <div style="font-size:12px;font-weight:600;color:#ef4444;">↓ -0.8%</div>
                <div style="font-size:10px;color:#a8b0aa;margin-top:6px;">Pulp & processing</div>
            </div>
            <div style="text-align:center;padding:18px 12px;background:#f8f6f0;border-radius:12px;">
                <div style="font-size:12px;color:#6b7c6e;margin-bottom:6px;">Neelam</div>
                <div style="font-size:28px;font-weight:700;color:#1a2e1f;">₹22</div>
                <div style="font-size:12px;font-weight:600;color:#22c55e;">↑ +1.4%</div>
                <div style="font-size:10px;color:#a8b0aa;margin-top:6px;">Local market</div>
            </div>
            <div style="text-align:center;padding:18px 12px;background:#f8f6f0;border-radius:12px;">
                <div style="font-size:12px;color:#6b7c6e;margin-bottom:6px;">Rasalu</div>
                <div style="font-size:28px;font-weight:700;color:#1a2e1f;">₹30</div>
                <div style="font-size:12px;font-weight:600;color:#22c55e;">↑ +3.2%</div>
                <div style="font-size:10px;color:#a8b0aa;margin-top:6px;">Premium table fruit</div>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
    ...
    for num,acc,icon,txt in [
        ...
        <div style="padding:20px;background:#f8f6f0;border-radius:12px;border-left:3px solid {acc};">
            ...
            <div style="font-size:11px;font-weight:700;color:{acc};
                margin-bottom:6px;letter-spacing:1px;">STEP {num}</div>
...
# ══════════════════════════════════════════════════════════════
    ...
    df_alt       = collect_alternatives(v_lat, v_lon, variety, radius=150)

    if df_alt.empty:
        st.warning(tx["no_results"])
        st.stop()

    df_result = calc_profit(df_alt, base_price, tonnes)
    df_result = df_result.drop_duplicates(subset=["Type","Name"]).sort_values(
        "Net_Profit", ascending=False).reset_index(drop=True)
    ...
    st.markdown(f"""
    <div style="background:
        linear-gradient(135deg,rgba(4,14,7,0.93) 0%,rgba(7,24,12,0.90) 100%),
        url('https://images.unsplash.com/photo-1592991538534-00e70e6a5b3f?w=1400&q=80&fit=crop');
        background-size:cover;background-position:center;
        ...
        <div style="position:absolute;right:32px;top:50%;transform:translateY(-50%);
            font-size:100px;opacity:0.06;pointer-events:none;">🏆</div>
        <div style="font-size:9px;letter-spacing:4px;text-transform:uppercase;
            color:rgba(212,175,55,0.65);margin-bottom:12px;">{tx['profit_summary']}</div>
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:24px;">
            <div>
                <div style="font-size:10px;color:rgba(245,240,232,0.4);margin-bottom:4px;">{tx['variety_selected']}</div>
                <div style="font-size:20px;font-weight:700;color:#f5f0e8;">{variety}</div>
            </div>
            <div>
                <div style="font-size:10px;color:rgba(245,240,232,0.4);margin-bottom:4px;">{tx['qty_lbl']}</div>
                <div style="font-size:20px;font-weight:700;color:#f5f0e8;">{tonnes} Tonnes</div>
            </div>
            <div>
                <div style="font-size:10px;color:rgba(245,240,232,0.4);margin-bottom:4px;">{tx['best_market']}</div>
                <div style="font-size:18px;font-weight:700;color:#d4af37;line-height:1.2;">{best_dest}</div>
                <div style="font-size:10px;color:rgba(212,175,55,0.5);">{best_cat}</div>
            </div>
            <div>
                <div style="font-size:10px;color:rgba(245,240,232,0.4);margin-bottom:4px;">{tx['est_profit']}</div>
                <div style="font-size:28px;font-weight:800;color:#22c55e;">₹{best_net:,}</div>
            </div>
        </div>
    </div>""", unsafe_allow_html=True)
        ...
        with col:
            ...
            <div style="background:{'linear-gradient(145deg,#040e07,#0a1c10)' if is_top else 'white'};
                ...
                <div style="font-size:17px;font-weight:700;
                    color:{'#f5f0e8' if is_top else '#1a2e1f'};margin-bottom:4px;line-height:1.25;">{d_}</div>
                <div style="display:inline-flex;align-items:center;gap:4px;
                    ...
                    <span style="font-size:11px;color:{row['color']};font-weight:500;">{c_}</span>
                </div>
                <div style="font-size:30px;font-weight:800;color:{acc};margin-bottom:4px;">
                    ₹{n_:,}</div>
                <div style="font-size:10px;
                    color:{'rgba(245,240,232,0.3)' if is_top else '#a0a8a2'};margin-bottom:16px;">
                ...
                <div style="border-top:1px solid {'rgba(255,255,255,0.06)' if is_top else 'rgba(0,0,0,0.05)'};
                    padding-top:14px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;">
                    <div>
                        <div style="font-size:9px;color:{'rgba(245,240,232,0.35)' if is_top else '#a0a8a2'};margin-bottom:2px;">{tx['revenue_lbl']}</div>
                        <div style="font-size:12px;font-weight:600;color:{'rgba(245,240,232,0.8)' if is_top else '#374151'};">₹{rev_:,}</div>
                    </div>
                    <div>
                        <div style="font-size:9px;color:{'rgba(245,240,232,0.35)' if is_top else '#a0a8a2'};margin-bottom:2px;">{tx['transport_lbl']}</div>
                        <div style="font-size:12px;font-weight:600;color:#ef4444;">₹{tra_:,}</div>
                    </div>
                    <div>
                        <div style="font-size:9px;color:{'rgba(245,240,232,0.35)' if is_top else '#a0a8a2'};margin-bottom:2px;">{tx['risk']}</div>
                        <div style="font-size:12px;font-weight:600;color:#f59e0b;">{rsk_}%</div>
                    </div>
                </div>
            </div>""", unsafe_allow_html=True)
    ...
    <div style="background:linear-gradient(135deg,#fffbeb,#fef3c7);border-radius:12px;
        ...
        <div>
            <div style="font-size:11px;font-weight:700;color:#92400e;
                letter-spacing:1px;text-transform:uppercase;margin-bottom:4px;">{tx['farmer_tip']}</div>
    ...
    with ch2:
        ...
        cat_color_map = {
            "Mandi":"#3b82f6","Processing":"#8b5cf6","Pulp":"#f59e0b",
            "Pickle":"#ec4899","Local Export":"#22c55e","Abroad Export":"#d4af37",
            "Cold Storage":"#06b6d4","FPO":"#84cc16",
        }
        pie_colors = [cat_color_map.get(c,"#888") for c in pie_df["Type"]]
        ...
        fig_pie.update_layout(
            ...
            hoverlabel=dict(bgcolor="#0a1c10", bordercolor="#d4af37",
    ...
    styled = (
        ...
        .format({
            tx["rev"]:  "₹{:,.0f}", tx["trans"]: "₹{:,.0f}",
            tx["net"]:  "₹{:,.0f}", tx["dist_km"]: "{:.1f}",
            tx["risk"]: "{:.2f}%",
        })
    ...
    st.markdown(f"""<div style="background:white;border-radius:14px;padding:22px;
        ...
        <div style="font-size:12px;color:#6b7280;margin-bottom:14px;">
            🏠 = Your farm &nbsp;|&nbsp; ★ = Best destination &nbsp;|&nbsp; Dots = Other top markets
        </div>""", unsafe_allow_html=True)
    ...
    # Gold route line to best destination
    folium.PolyLine(
        [(v_lat, v_lon), (best_row["Lat"], best_row["Lon"])],
        color="#d4af37", weight=3.5, opacity=0.9, dash_array="8 5"
    ).add_to(m)

    # Other top 10 markers
